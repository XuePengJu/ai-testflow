...
type View = "main" | "settings" | "admin" | "knowledge";
...
export default function App() {
  ...
  useEffect(() => {
    const h = (e: Event) => {
      ...
      if (d === "main" || d === "settings" || d === "admin" || d === "knowledge") setView(d);
    };
      ...
      <nav className={"rail" + (railCollapsed ? " collapsed" : "")} aria-label="主导航">
        ...
        {!me || !role ? (
          ...
          <>
            ...
            {railBtn("logout", <LogOut />, "退出登录", true, { onClick: logout, cls: "rail-danger" })}
          </>
        )}
      </nav>
